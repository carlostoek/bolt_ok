...
Los modelos de IA (GPT, Claude, Gemini, etc.) no reconocen automáticamente sistemas de agentes cuando son invocados con `@[agente]`. Este sistema implementa un protocolo manual universal que simula un ecosistema de agentes coordinado por un Coordinador Maestro.
...
Mantén este mapeo expandido de agentes especializados:

**DESARROLLO:**
- `@architect` → `agents/architect.md` - Diseño de sistemas, patrones, escalabilidad
- `@backend-dev` → `agents/backend_developer.md` - APIs, microservicios, bases de datos
- `@frontend-dev` → `agents/frontend_developer.md` - UI/UX, interfaces, experiencia usuario  
- `@mobile-dev` → `agents/mobile_developer.md` - Apps nativas, cross-platform
- `@fullstack-dev` → `agents/fullstack_developer.md` - Full-stack development

**OPERACIONES:**
- `@devops` → `agents/devops_engineer.md` - CI/CD, infrastructure, deployment
- `@security` → `agents/security_engineer.md` - Autenticación, autorización, compliance
- `@performance` → `agents/performance_engineer.md` - Optimización, benchmarks, scaling

**CALIDAD:**
- `@qa-engineer` → `agents/qa_engineer.md` - Testing, validación, quality assurance
- `@test-automation` → `agents/test_automation.md` - Automated testing, frameworks

**DATOS:**
- `@data-engineer` → `agents/data_engineer.md` - ETL, pipelines, data architecture
- `@data-scientist` → `agents/data_scientist.md` - Analytics, ML, insights
- `@bi-analyst` → `agents/bi_analyst.md` - Business intelligence, reporting

**ESPECIALISTAS:**
- `@integration` → `agents/integration_specialist.md` - APIs, conectores, middleware
- `@cloud-architect` → `agents/cloud_architect.md` - AWS, Azure, GCP architectures
- `@database` → `agents/database_specialist.md` - Database design, optimization
...
**ESTE SISTEMA TRANSFORMA CUALQUIER MODELO DE IA EN UN ECOSISTEMA COORDINADO DE AGENTES ESPECIALIZADOS DE ALTO RENDIMIENTO** 🚀

---

*Versión: Sistema Universal Manual v2.0 - Compatible con GPT, Claude, Gemini, Llama y cualquier LLM que procese instrucciones estructuradas*
