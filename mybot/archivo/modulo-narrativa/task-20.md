# modulo-narrativa - Task 20

Execute task 20 for the modulo-narrativa specification.

## Task Description
Enhance narrative service with analytics integration

## Code Reuse
**Leverage existing code**: existing narrative progression logic, user state tracking
...
## Usage
```
/Task:20-modulo-narrativa
```

## Instructions

Execute with @spec-task-executor agent the following task: "Enhance narrative service with analytics integration"

```
Use the @spec-task-executor agent to implement task 20: "Enhance narrative service with analytics integration" for the modulo-narrativa specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Enhance narrative service with analytics integration
- Leverage: existing narrative progression logic, user state tracking
- Requirements: 3.1, 4.1

## Instructions
- Implement ONLY task 20: "Enhance narrative service with analytics integration"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modulo-narrativa 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modulo-narrativa 20 --mode complete
```
