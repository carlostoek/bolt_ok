...
Execute task 1 for the ramificado specification.

## Task Description
Create ArchetypeScores dataclass in services/archetype_analyzer.py
...
Execute with @spec-task-executor agent the following task: "Create ArchetypeScores dataclass in services/archetype_analyzer.py"

```
Use the @spec-task-executor agent to implement task 1: "Create ArchetypeScores dataclass in services/archetype_analyzer.py" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 1
- Description: Create ArchetypeScores dataclass in services/archetype_analyzer.py
- Requirements: 4.1

## Instructions
- Implement ONLY task 1: "Create ArchetypeScores dataclass in services/archetype_analyzer.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 1 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 1 --mode complete
```
