...
Execute task 36 for the ramificado specification.

## Task Description
Implement fallback integration with existing 5-archetype system

## Code Reuse
**Leverage existing code**: existing archetype classification patterns

## Requirements Reference
**Requirements**: 6.8, Reliability section
...
Execute with @spec-task-executor agent the following task: "Implement fallback integration with existing 5-archetype system"

```
Use the @spec-task-executor agent to implement task 36: "Implement fallback integration with existing 5-archetype system" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 36
- Description: Implement fallback integration with existing 5-archetype system
- Leverage: existing archetype classification patterns
- Requirements: 6.8, Reliability section

## Instructions
- Implement ONLY task 36: "Implement fallback integration with existing 5-archetype system"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 36 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 36 --mode complete
```
