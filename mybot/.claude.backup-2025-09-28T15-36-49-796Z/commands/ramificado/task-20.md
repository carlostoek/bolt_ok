...
Execute task 20 for the ramificado specification.

## Task Description
Create database migration script for ArchetypeClassification model extensions

## Code Reuse
**Leverage existing code**: existing migration patterns in database/migrations/
...
Execute with @spec-task-executor agent the following task: "Create database migration script for ArchetypeClassification model extensions"

```
Use the @spec-task-executor agent to implement task 20: "Create database migration script for ArchetypeClassification model extensions" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Create database migration script for ArchetypeClassification model extensions
- Leverage: existing migration patterns in database/migrations/
- Requirements: 4.7, 6.4

## Instructions
- Implement ONLY task 20: "Create database migration script for ArchetypeClassification model extensions"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 20 --mode complete
```
