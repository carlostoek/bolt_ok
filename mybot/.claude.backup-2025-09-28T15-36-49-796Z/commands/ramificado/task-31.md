...
Execute task 31 for the ramificado specification.

## Task Description
Create unit tests for ArchetypeAnalyzer core methods
...
Execute with @spec-task-executor agent the following task: "Create unit tests for ArchetypeAnalyzer core methods"

```
Use the @spec-task-executor agent to implement task 31: "Create unit tests for ArchetypeAnalyzer core methods" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 31
- Description: Create unit tests for ArchetypeAnalyzer core methods
- Requirements: 4.1, 4.2, 4.3

## Instructions
- Implement ONLY task 31: "Create unit tests for ArchetypeAnalyzer core methods"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 31 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 31 --mode complete
```
