...
Execute task 40 for the ramificado specification.

## Task Description
Create archetype classification monitoring and alerting

## Code Reuse
**Leverage existing code**: existing monitoring patterns

## Requirements Reference
**Requirements**: Reliability section, performance monitoring
...
Execute with @spec-task-executor agent the following task: "Create archetype classification monitoring and alerting"

```
Use the @spec-task-executor agent to implement task 40: "Create archetype classification monitoring and alerting" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 40
- Description: Create archetype classification monitoring and alerting
- Leverage: existing monitoring patterns
- Requirements: Reliability section, performance monitoring

## Instructions
- Implement ONLY task 40: "Create archetype classification monitoring and alerting"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 40 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 40 --mode complete
```
