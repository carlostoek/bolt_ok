# modulo-admon - Task 14

Execute task 14 for the modulo-admon specification.

## Task Description
Add automated cleanup tasks to services/automation_service.py

## Code Reuse
**Leverage existing code**: existing cleanup patterns, database session management
...
## Usage
```
/Task:14-modulo-admon
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add automated cleanup tasks to services/automation_service.py"

```
Use the @spec-task-executor agent to implement task 14: "Add automated cleanup tasks to services/automation_service.py" for the modulo-admon specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: Add automated cleanup tasks to services/automation_service.py
- Leverage: existing cleanup patterns, database session management
- Requirements: 6.3, 6.4

## Instructions
- Implement ONLY task 14: "Add automated cleanup tasks to services/automation_service.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modulo-admon 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modulo-admon 14 --mode complete
```
