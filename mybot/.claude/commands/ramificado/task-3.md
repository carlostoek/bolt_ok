...
Execute task 3 for the ramificado specification.

## Task Description
Extend ArchetypeClassification model in database/emotional_models.py with primary score fields
...
Execute with @spec-task-executor agent the following task: "Extend ArchetypeClassification model in database/emotional_models.py with primary score fields"

```
Use the @spec-task-executor agent to implement task 3: "Extend ArchetypeClassification model in database/emotional_models.py with primary score fields" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 3
- Description: Extend ArchetypeClassification model in database/emotional_models.py with primary score fields
- Leverage: existing ArchetypeClassification model structure
- Requirements: 1.8, 4.7

## Instructions
- Implement ONLY task 3: "Extend ArchetypeClassification model in database/emotional_models.py with primary score fields"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 3 --mode complete
```
