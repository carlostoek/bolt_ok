...
Execute task 27 for the ramificado specification.

## Task Description
Implement get_archetype_confidence method in ArchetypeIntegrationService
...
Execute with @spec-task-executor agent the following task: "Implement get_archetype_confidence method in ArchetypeIntegrationService"

```
Use the @spec-task-executor agent to implement task 27: "Implement get_archetype_confidence method in ArchetypeIntegrationService" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 27
- Description: Implement get_archetype_confidence method in ArchetypeIntegrationService
- Requirements: 4.6, 6.1

## Instructions
- Implement ONLY task 27: "Implement get_archetype_confidence method in ArchetypeIntegrationService"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 27 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 27 --mode complete
```
