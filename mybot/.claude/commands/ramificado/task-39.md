...
Execute task 39 for the ramificado specification.

## Task Description
Add archetype management to existing admin interface

## Code Reuse
**Leverage existing code**: existing admin handler patterns from handlers/admin/

## Requirements Reference
**Requirements**: Usability section - admin interface integration
...
Execute with @spec-task-executor agent the following task: "Add archetype management to existing admin interface"

```
Use the @spec-task-executor agent to implement task 39: "Add archetype management to existing admin interface" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 39
- Description: Add archetype management to existing admin interface
- Leverage: existing admin handler patterns from handlers/admin/
- Requirements: Usability section - admin interface integration

## Instructions
- Implement ONLY task 39: "Add archetype management to existing admin interface"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 39 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 39 --mode complete
```
