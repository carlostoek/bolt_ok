...
Execute task 32 for the ramificado specification.

## Task Description
Create integration tests for complete archetype analysis flow

## Code Reuse
**Leverage existing code**: existing integration test patterns from tests/emotional/

## Requirements Reference
**Requirements**: 1.1, 4.7, 6.1, 6.8
...
Execute with @spec-task-executor agent the following task: "Create integration tests for complete archetype analysis flow"

```
Use the @spec-task-executor agent to implement task 32: "Create integration tests for complete archetype analysis flow" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 32
- Description: Create integration tests for complete archetype analysis flow
- Leverage: existing integration test patterns from tests/emotional/
- Requirements: 1.1, 4.7, 6.1, 6.8

## Instructions
- Implement ONLY task 32: "Create integration tests for complete archetype analysis flow"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 32 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 32 --mode complete
```
