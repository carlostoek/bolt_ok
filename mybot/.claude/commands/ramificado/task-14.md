...
Execute task 14 for the ramificado specification.

## Task Description
Implement _calculate_primary_archetype method in ArchetypeAnalyzer class
...
Execute with @spec-task-executor agent the following task: "Implement _calculate_primary_archetype method in ArchetypeAnalyzer class"

```
Use the @spec-task-executor agent to implement task 14: "Implement _calculate_primary_archetype method in ArchetypeAnalyzer class" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: Implement _calculate_primary_archetype method in ArchetypeAnalyzer class
- Requirements: 4.2

## Instructions
- Implement ONLY task 14: "Implement _calculate_primary_archetype method in ArchetypeAnalyzer class"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 14 --mode complete
```
