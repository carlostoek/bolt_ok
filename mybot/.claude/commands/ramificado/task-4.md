...
Execute task 4 for the ramificado specification.

## Task Description
Extend ArchetypeClassification model in database/emotional_models.py with sub-archetype score fields

## Code Reuse
**Leverage existing code**: existing ArchetypeClassification model patterns
...
Execute with @spec-task-executor agent the following task: "Extend ArchetypeClassification model in database/emotional_models.py with sub-archetype score fields"

```
Use the @spec-task-executor agent to implement task 4: "Extend ArchetypeClassification model in database/emotional_models.py with sub-archetype score fields" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 4
- Description: Extend ArchetypeClassification model in database/emotional_models.py with sub-archetype score fields
- Leverage: existing ArchetypeClassification model patterns
- Requirements: 4.3, 4.7

## Instructions
- Implement ONLY task 4: "Extend ArchetypeClassification model in database/emotional_models.py with sub-archetype score fields"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 4 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 4 --mode complete
```
