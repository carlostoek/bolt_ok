...
Execute task 15 for the ramificado specification.

## Task Description
Implement _determine_sub_archetype method in ArchetypeAnalyzer class
...
Execute with @spec-task-executor agent the following task: "Implement _determine_sub_archetype method in ArchetypeAnalyzer class"

```
Use the @spec-task-executor agent to implement task 15: "Implement _determine_sub_archetype method in ArchetypeAnalyzer class" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 15
- Description: Implement _determine_sub_archetype method in ArchetypeAnalyzer class
- Requirements: 4.3, 4.5

## Instructions
- Implement ONLY task 15: "Implement _determine_sub_archetype method in ArchetypeAnalyzer class"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 15 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 15 --mode complete
```
