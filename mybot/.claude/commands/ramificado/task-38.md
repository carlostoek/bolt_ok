...
Execute task 38 for the ramificado specification.

## Task Description
Create archetype analysis service documentation
...
Execute with @spec-task-executor agent the following task: "Create archetype analysis service documentation"

```
Use the @spec-task-executor agent to implement task 38: "Create archetype analysis service documentation" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 38
- Description: Create archetype analysis service documentation
- Requirements: Usability section - admin interface integration

## Instructions
- Implement ONLY task 38: "Create archetype analysis service documentation"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 38 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 38 --mode complete
```
