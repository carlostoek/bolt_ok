# modulo-narrativa - Task 6

Execute task 6 for the modulo-narrativa specification.

## Task Description
Implement narrative consistency validation in admin service

## Code Reuse
**Leverage existing code**: existing NarrativeChoice relationships, graph traversal patterns
...
## Usage
```
/Task:6-modulo-narrativa
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement narrative consistency validation in admin service"

```
Use the @spec-task-executor agent to implement task 6: "Implement narrative consistency validation in admin service" for the modulo-narrativa specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: Implement narrative consistency validation in admin service
- Leverage: existing NarrativeChoice relationships, graph traversal patterns
- Requirements: 1.3, 1.5

## Instructions
- Implement ONLY task 6: "Implement narrative consistency validation in admin service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modulo-narrativa 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modulo-narrativa 6 --mode complete
```
