# modulo-narrativa - Task 12

Execute task 12 for the modulo-narrativa specification.

## Task Description
Implement user segmentation analytics

## Code Reuse
**Leverage existing code**: existing user data, point system analytics
...
## Usage
```
/Task:12-modulo-narrativa
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement user segmentation analytics"

```
Use the @spec-task-executor agent to implement task 12: "Implement user segmentation analytics" for the modulo-narrativa specification and include all the below context.
...
## Task Details
- Task ID: 12
- Description: Implement user segmentation analytics
- Leverage: existing user data, point system analytics
- Requirements: 4.3, 4.4

## Instructions
- Implement ONLY task 12: "Implement user segmentation analytics"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modulo-narrativa 12 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modulo-narrativa 12 --mode complete
```
