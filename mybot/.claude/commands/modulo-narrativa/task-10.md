# modulo-narrativa - Task 10

Execute task 10 for the modulo-narrativa specification.

## Task Description
Implement personalized content generation in UX service

## Code Reuse
**Leverage existing code**: existing teaser system in CoordinadorCentral, user archetype detection
...
## Usage
```
/Task:10-modulo-narrativa
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement personalized content generation in UX service"

```
Use the @spec-task-executor agent to implement task 10: "Implement personalized content generation in UX service" for the modulo-narrativa specification and include all the below context.
...
## Task Details
- Task ID: 10
- Description: Implement personalized content generation in UX service
- Leverage: existing teaser system in CoordinadorCentral, user archetype detection
- Requirements: 3.2, 3.4

## Instructions
- Implement ONLY task 10: "Implement personalized content generation in UX service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modulo-narrativa 10 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modulo-narrativa 10 --mode complete
```
