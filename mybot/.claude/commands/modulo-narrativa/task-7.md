# modulo-narrativa - Task 7

Execute task 7 for the modulo-narrativa specification.

## Task Description
Create lore management service

## Code Reuse
**Leverage existing code**: services/shop
...
## Usage
```
/Task:7-modulo-narrativa
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create lore management service"

```
Use the @spec-task-executor agent to implement task 7: "Create lore management service" for the modulo-narrativa specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: Create lore management service
- Leverage: services/shop
- Requirements: 2.1, 2.2

## Instructions
- Implement ONLY task 7: "Create lore management service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modulo-narrativa 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modulo-narrativa 7 --mode complete
```
