...
Execute task 28 for the ramificado specification.

## Task Description
Integrate ArchetypeAnalyzer with CoordinadorCentral workflows

## Code Reuse
**Leverage existing code**: existing CoordinadorCentral workflows and AccionUsuario patterns
...
Execute with @spec-task-executor agent the following task: "Integrate ArchetypeAnalyzer with CoordinadorCentral workflows"

```
Use the @spec-task-executor agent to implement task 28: "Integrate ArchetypeAnalyzer with CoordinadorCentral workflows" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 28
- Description: Integrate ArchetypeAnalyzer with CoordinadorCentral workflows
- Leverage: existing CoordinadorCentral workflows and AccionUsuario patterns
- Requirements: 6.5, 6.1

## Instructions
- Implement ONLY task 28: "Integrate ArchetypeAnalyzer with CoordinadorCentral workflows"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 28 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 28 --mode complete
```
