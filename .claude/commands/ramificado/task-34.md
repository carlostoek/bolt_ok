...
Execute task 34 for the ramificado specification.

## Task Description
Create performance tests for archetype analysis system

## Requirements Reference
**Requirements**: Performance section - 2 seconds, 100 concurrent users
...
Execute with @spec-task-executor agent the following task: "Create performance tests for archetype analysis system"

```
Use the @spec-task-executor agent to implement task 34: "Create performance tests for archetype analysis system" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 34
- Description: Create performance tests for archetype analysis system
- Requirements: Performance section - 2 seconds, 100 concurrent users

## Instructions
- Implement ONLY task 34: "Create performance tests for archetype analysis system"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 34 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 34 --mode complete
```
