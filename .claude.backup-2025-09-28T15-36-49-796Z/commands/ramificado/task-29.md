...
Execute task 29 for the ramificado specification.

## Task Description
Create unit tests for ArchetypeScores and SubArchetypeScores dataclasses

## Code Reuse
**Leverage existing code**: existing test patterns from tests/test
...
Execute with @spec-task-executor agent the following task: "Create unit tests for ArchetypeScores and SubArchetypeScores dataclasses"

```
Use the @spec-task-executor agent to implement task 29: "Create unit tests for ArchetypeScores and SubArchetypeScores dataclasses" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 29
- Description: Create unit tests for ArchetypeScores and SubArchetypeScores dataclasses
- Leverage: existing test patterns from tests/test
- Requirements: 4.1, 4.3

## Instructions
- Implement ONLY task 29: "Create unit tests for ArchetypeScores and SubArchetypeScores dataclasses"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 29 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 29 --mode complete
```
