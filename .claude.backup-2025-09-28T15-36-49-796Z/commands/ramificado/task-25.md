...
Execute task 25 for the ramificado specification.

## Task Description
Create ArchetypeIntegrationService in services/archetype_integration_service.py
...
Execute with @spec-task-executor agent the following task: "Create ArchetypeIntegrationService in services/archetype_integration_service.py"

```
Use the @spec-task-executor agent to implement task 25: "Create ArchetypeIntegrationService in services/archetype_integration_service.py" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: Create ArchetypeIntegrationService in services/archetype_integration_service.py
- Leverage: existing service patterns from EmotionalAnalysisService
- Requirements: 6.1, 6.5, 6.8

## Instructions
- Implement ONLY task 25: "Create ArchetypeIntegrationService in services/archetype_integration_service.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 25 --mode complete
```
