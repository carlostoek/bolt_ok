...
Execute task 2 for the ramificado specification.

## Task Description
Create SubArchetypeScores dataclass in services/archetype_analyzer.py
...
Execute with @spec-task-executor agent the following task: "Create SubArchetypeScores dataclass in services/archetype_analyzer.py"

```
Use the @spec-task-executor agent to implement task 2: "Create SubArchetypeScores dataclass in services/archetype_analyzer.py" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 2
- Description: Create SubArchetypeScores dataclass in services/archetype_analyzer.py
- Requirements: 4.3, 4.5

## Instructions
- Implement ONLY task 2: "Create SubArchetypeScores dataclass in services/archetype_analyzer.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 2 --mode complete
```
