...
Execute task 5 for the ramificado specification.

## Task Description
Add cognitive style tracking fields to ArchetypeClassification model in database/emotional_models.py

## Code Reuse
**Leverage existing code**: existing ArchetypeClassification model structure
...
Execute with @spec-task-executor agent the following task: "Add cognitive style tracking fields to ArchetypeClassification model in database/emotional_models.py"

```
Use the @spec-task-executor agent to implement task 5: "Add cognitive style tracking fields to ArchetypeClassification model in database/emotional_models.py" for the ramificado specification and include all the below context.
...
## Task Details
- Task ID: 5
- Description: Add cognitive style tracking fields to ArchetypeClassification model in database/emotional_models.py
- Leverage: existing ArchetypeClassification model structure
- Requirements: 3.1, 3.4, 3.5

## Instructions
- Implement ONLY task 5: "Add cognitive style tracking fields to ArchetypeClassification model in database/emotional_models.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ramificado 5 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ramificado 5 --mode complete
```
